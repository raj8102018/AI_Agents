...
def preprocess_data(input_file, output_file):
    ...
    try:
        ...
        hot_industries = ['IT Services And IT Consulting', 'Software Development', 'Medical Device', 'Pharmaceuticals', 'Business Consulting And Services','Hospitals And Health Care']
        warm_industries = ['Health, Wellness & Fitness', 'Nonprofit Organizations', 'Government Administration', 'Manufacturing', 'Appliances, Electrical, And Electronics Manufacturing']
        ...
        df = df[['Name', 'processed job_title', 'processed Industry_name', 'lead_type', 'lead_label']]
...
if __name__ == "__main__":
    preprocess_data('data/raw/leads_dataset.csv', 'data/processed/cleaned_leads.csv')
